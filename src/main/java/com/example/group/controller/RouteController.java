...
public class RouteController {
    ...
    @PostMapping("/routes")
    public String saveRoute(@RequestBody Route route, HttpSession session) {
    ...
    public String shareRoute(@PathVariable Long id, HttpSession session) {
        ...
        return "redirect:/route-shared/" + id;
    }


    @GetMapping("/route-shared/{id}")
    public String viewRoute(@PathVariable Long id,
                            Model model,
